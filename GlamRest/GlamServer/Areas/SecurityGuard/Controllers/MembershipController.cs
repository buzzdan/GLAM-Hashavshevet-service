...
using viewModels = GlamServer.Areas.SecurityGuard.ViewModels;
...
namespace GlamServer.Areas.SecurityGuard.Controllers
{
    ...
    public partial class MembershipController : BaseController
    {
        ...
        #endregion Ajax methods for Updating the user

        #endregion View User Details Methods
        ...
        #endregion Grant Users with Roles Methods
    }
}